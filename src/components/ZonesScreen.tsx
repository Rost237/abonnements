  ...
  return (
    <div className="space-y-5 max-w-4xl">
      ...
      <div className="relative">
        ...
        <Input value={search} onChange={e => setSearch(e.target.value)} placeholder="Rechercher une zone..." className="pl-9 h-10 rounded-md" />
      </div>
      ...
      <p className="text-xs text-muted-foreground">{zones.length} zone(s) au total</p>
    </div>
  );
}
